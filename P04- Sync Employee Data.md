...
3. Confirm that employee identity and core employment data match the approved HR system.
...
Fallback:
If HRS and P03 records do not match, stop synchronisation and route the case to HR for human review.
